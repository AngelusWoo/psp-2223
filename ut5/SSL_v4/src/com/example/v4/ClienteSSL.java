...
public class ClienteSSL {
    public static void main(String[] args) throws IOException, KeyStoreException, CertificateException, NoSuchAlgorithmException, KeyManagementException {
        ...
        FileInputStream ficCerConf = new FileInputStream("src/com/example/v4/CliCertConfianza");
        ...
        FileInputStream ficAlmacen = new FileInputStream("src/com/example/v4/AlmacenCli");
